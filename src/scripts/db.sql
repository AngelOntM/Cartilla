...
USE cartilla;
INSERT INTO tipousu (TIU_NOMBRE) 
...
USE cartilla;
INSERT INTO programa (PRG_CLAVE,PRG_NOMBRE,PRG_RUTA) 
VALUES("PRG10000","Cartilla","cartilla"),("PRG20000","Mascotas","mascotas"),("PRG30000","Vacunas","vacunas"),("PRG40000","Fotos","fotos"),
("PRG50000","Proveedores","proveedor"),("PRG60000","Citas","citas"),("PRG70000","Perfil","perfil"),("PRG80000","Tipo Usuarios","tipo_usuario")
,("PRG90000","Programas","programas"),("PRG100000","Programas por Menú","programas_menu"),("PRG110000","Programas por Tipo","programas_tipo");
...
USE cartilla;
INSERT INTO menu(MEN_CLAVE,MEN_NOMBRE) 
values ("0001","Proveedor"),("0002","Propietario");
...
USE cartilla;
INSERT INTO especialidad (ESP_NOMBRE,ESP_DESC) 
values ("Veterinaria","Inyeeciones y Tratamiento"),("Farmacia","Consultas y medicacion"),("Clinica","Operaciones y tratamiento");
...
USE cartilla;
INSERT INTO vacuna(RAZ_NUMCTRL,VAC_NOMBRE,VAC_DESC) 
values (1,"Sextuple","Vacuna cada año"),(1,"Rabia","Vacuna contra rabia cada año"),(2,"Sextuple","Vacuna cada año"),(2,"Rabia","Vacuna anual contra la rabia");
...
USE cartilla;
INSERT INTO PROVEEDOR (PRV_NOMBRE,PRV_PROPIETARIO,PRV_CELULAR,PRV_TELOFICINA,PRV_CORREO,PRV_CONTRA) 
VALUES ("Vet1","Angel1",1234567890,1234567891,"angel@gmail.com1","angel1"),("Vet2","Angel2",1234567892,1234567893,"angel@gmail.com2","angel2");
...
USE cartilla;
INSERT INTO propietario (PRO_NOMBRE,PRO_CELULAR,PRO_CORREO,PRO_CONTRA) 
VALUES ("Angel2",1234567891,"angel@gmail.com2","angel2"),("Angel3",1234567893,"angel@gmail.com3","angel3");
...
USE cartilla;
INSERT INTO mascota (PRO_NUMCTRL,MAS_NOMBRE,MAS_FECHANAC,MAS_RAZA,RAZ_NUMCTRL) 
VALUES (1,"Chikis","2020-08-10","pitbull",1),(2,"Manchas","2021-09-10","chihuahua",1);
...
USE cartilla;
INSERT INTO sucxprv (PRV_NUMCTRL,SXP_NOMBRE,SXP_DIRECCION,SXP_COLONIA,SXP_CP,SXP_ENCARGADO,SXP_TELEFONO,SXP_LAT,SXP_LON)
VALUES (1,"Vet1","Bravo #123","Bravo","27000","pepe",1234567890,"",""),(2,"Vet2","Bravo #124","Brava","27001","pepe1",1234567891,"","");
...
USE cartilla;
INSERT INTO serxmas (MAS_NUMCTRL,SXM_FECHA,SXM_PRECIO) values (1,"2021-06-14",100.00),(2,"2022-06-15",100.50);
...
USE cartilla;
INSERT INTO caldia (SXP_NUMCTRL,CAD_DIA) values(1,7),(1,6),(2,7),(2,6);
...
USE cartilla;
INSERT INTO calfecha (SXP_NUMCTRL,CAF_FECHA) values (1,"2022-05-09"),(1,"2022-05-10");
...
USE cartilla;
INSERT INTO proxmen(PRG_NUMCTRL,MEN_NUMCTRL) VALUES (1,1),(2,1),(3,1),(4,1),(1,2),(2,2),(3,2),(4,2);
