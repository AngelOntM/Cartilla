      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            _context4.next = 6;
            return connection.query("INSERT INTO programa(PRG_CLAVE, PRG_NOMBRE) VALUES (?, ?)", [req.body.PRG_CLAVE, req.body.PRG_NOMBRE]);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            _context6.next = 6;
            return connection.query('UPDATE programa SET PRG_CLAVE = ?, PRG_NOMBRE = ? WHERE PRG_NUMCTRL = ?', [req.body.PRG_CLAVE, req.body.PRG_NOMBRE, req.params.id]);
