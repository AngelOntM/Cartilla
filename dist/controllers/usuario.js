...
exports.updateUsuario = exports.getUsuarios = exports.getUsuario = exports.deleteUsuario = exports.createUsuario = exports.countUsuarios = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query('SELECT * FROM usuario WHERE VAC_NUMCTRL = ?', [req.params.id]);
...
var countUsuarios = /*#__PURE__*/function () {
  ...
  return function countUsuarios(_x5, _x6) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connection.query("INSERT INTO usuario(title, description) VALUES (?, ?)", [req.body.title, req.body.description]);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connection.query('DELETE FROM usuario WHERE VAC_NUMCTRL = ?', [req.params.id]);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.next = 5;
            return connection.query('UPDATE usuario SET ? WHERE VAC_NUMCTRL = ?', [req.body, req.params.id]);
